...
class Identity {
  ...
  @override
  String toString() => 'Identity[subject=$subject, name=$name, email=$email, teams=$teams, roles=$roles]';
  ...
  static Map<String, List<Identity>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = Identity.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
