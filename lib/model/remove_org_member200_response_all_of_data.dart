...
class RemoveOrgMember200ResponseAllOfData {
  ...
  static RemoveOrgMember200ResponseAllOfData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'removed'), 'Required key "RemoveOrgMember200ResponseAllOfData[removed]" is missing from JSON.');
        assert(json[r'removed'] != null, 'Required key "RemoveOrgMember200ResponseAllOfData[removed]" has a null value in JSON.');
        return true;
      }());
