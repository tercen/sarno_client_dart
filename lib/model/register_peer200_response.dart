...
class RegisterPeer200Response {
  /// Returns a new [RegisterPeer200Response] instance.
  RegisterPeer200Response({
  ...
  ///
  RegisterPeer200ResponseAllOfData? data;

  @override
  bool operator ==(Object other) => identical(this, other) || other is RegisterPeer200Response &&
  ...
  @override
  String toString() => 'RegisterPeer200Response[success=$success, data=$data]';
  ...
  /// Returns a new [RegisterPeer200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RegisterPeer200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'success'), 'Required key "RegisterPeer200Response[success]" is missing from JSON.');
        assert(json[r'success'] != null, 'Required key "RegisterPeer200Response[success]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<RegisterPeer200Response> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RegisterPeer200Response>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RegisterPeer200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RegisterPeer200Response> mapFromJson(dynamic json) {
    final map = <String, RegisterPeer200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RegisterPeer200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RegisterPeer200Response-objects as value to a dart map
  static Map<String, List<RegisterPeer200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RegisterPeer200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RegisterPeer200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
