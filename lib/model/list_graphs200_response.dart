...
class ListGraphs200Response {
  ...
  static ListGraphs200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'success'), 'Required key "ListGraphs200Response[success]" is missing from JSON.');
        assert(json[r'success'] != null, 'Required key "ListGraphs200Response[success]" has a null value in JSON.');
        return true;
      }());
