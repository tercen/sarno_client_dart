  ...
  static HealthData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        ...
        assert(json.containsKey(r'version'), 'Required key "HealthData[version]" is missing from JSON.');
        assert(json[r'version'] != null, 'Required key "HealthData[version]" has a null value in JSON.');
        return true;
      }());
