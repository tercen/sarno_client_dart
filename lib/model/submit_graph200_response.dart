...
class SubmitGraph200Response {
  /// Returns a new [SubmitGraph200Response] instance.
  SubmitGraph200Response({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SubmitGraph200Response &&
  ...
  @override
  String toString() => 'SubmitGraph200Response[success=$success, data=$data]';
  ...
  /// Returns a new [SubmitGraph200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SubmitGraph200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'success'), 'Required key "SubmitGraph200Response[success]" is missing from JSON.');
        assert(json[r'success'] != null, 'Required key "SubmitGraph200Response[success]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<SubmitGraph200Response> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubmitGraph200Response>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubmitGraph200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SubmitGraph200Response> mapFromJson(dynamic json) {
    final map = <String, SubmitGraph200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SubmitGraph200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SubmitGraph200Response-objects as value to a dart map
  static Map<String, List<SubmitGraph200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SubmitGraph200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SubmitGraph200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
