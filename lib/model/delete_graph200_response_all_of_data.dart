...
class DeleteGraph200ResponseAllOfData {
  ...
  static DeleteGraph200ResponseAllOfData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'deleted'), 'Required key "DeleteGraph200ResponseAllOfData[deleted]" is missing from JSON.');
        assert(json[r'deleted'] != null, 'Required key "DeleteGraph200ResponseAllOfData[deleted]" has a null value in JSON.');
        return true;
      }());
