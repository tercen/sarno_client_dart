...
String parameterToString(dynamic value) {
  ...
  if (value is OrgRole) {
    return OrgRoleTypeTransformer().encode(value).toString();
  }
  if (value is ProjectPermission) {
    return ProjectPermissionTypeTransformer().encode(value).toString();
  }
  ...
  if (value is Visibility) {
    return VisibilityTypeTransformer().encode(value).toString();
  }
