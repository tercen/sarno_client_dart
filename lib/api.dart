...
part 'model/document_peek.dart';
part 'model/document_peek_columns_inner.dart';
part 'model/document_schema.dart';
part 'model/folder.dart';
part 'model/get_document_schema200_response.dart';
...
part 'model/merge_branches200_response.dart';
part 'model/merge_branches409_response.dart';
part 'model/merge_conflict.dart';
part 'model/merge_conflict_payload.dart';
part 'model/merge_request.dart';
part 'model/merge_result.dart';
...
part 'model/peek_document200_response.dart';
